...
const LOCALHOST_CAR_API = "http://192.168.1.7:8080/api/vehicle";
...
const Car = () => {
  ...
  const checkDatabaseFirst = async () => {
    try {
      ...
      const apiUrl = `http://192.168.1.7:8080/api/vehicle/getcardata?${queryParams.toString()}`;
  ...
  const ThirdPartyRow = ({ category, cc, amount }) => (
    <View style={styles.thirdPartyRow}>
      <View style={styles.thirdPartyLeft}>
        <Icon name="car-sport-outline" size={18} color="#6366F1" />
      ...
      >
        ...
        <View style={styles.headerContainer}>
          <View style={styles.headerGradient}>
            <Icon name="car-sport" size={48} color="#FFFFFF" />
            <Text style={styles.title}>Vehicle Insurance Lookup</Text>
            <Text style={styles.subtitle}>Complete vehicle & insurance information</Text>
          </View>
        </View>
        
        {/* Enhanced Form Container */}
        <View style={styles.formContainer}>
          <Text style={styles.formTitle}>Enter Vehicle Details</Text>
          
          <View style={styles.inputContainer}>
            <View style={styles.inputIconContainer}>
              <Icon name="car" size={22} color="#6366F1" />
            </View>
            <TextInput
              style={styles.input}
          ...
          >
            ...
            <View style={styles.dataContent}>
              <Text style={styles.sectionTitle}>
                <Icon name="information-circle" size={20} color="#6366F1" /> Vehicle Information
              </Text>
...
{/*  */}
            ...
            {/* EXPANDABLE SECTIONS MOVED AFTER PREMIUM BUTTON */}
        ...
        <View style={styles.infoSectionsContainer}>
              ...
              <ExpandableSection
                title="What's Covered in Car Insurance"
                icon="shield-checkmark"
              ...
              >
                ...
                <CoverageItem icon="car-sport" text="Own Damage (Accident, Fire, Theft)" isCovered={true} />
                <CoverageItem icon="umbrella" text="Natural Calamities (Flood, Earthquake)" isCovered={true} />
                <CoverageItem icon="flame" text="Man-made Calamities (Riots, Strikes)" isCovered={true} />
                <CoverageItem icon="people" text="Third Party Liability (Bodily Injury)" isCovered={true} />
                <CoverageItem icon="car" text="Third Party Property Damage" isCovered={true} />
                ...
                <CoverageItem icon="document-text" text="Driving Without Valid License" isCovered={false} />
                <CoverageItem icon="close-circle" text="Consequential Damage" isCovered={false} />
                <CoverageItem icon="construct" text="Mechanical/Electrical Breakdown" isCovered={false} />
                <CoverageItem icon="nuclear" text="War, Nuclear Risks" isCovered={false} />
                <CoverageItem icon="ban" text="Use Outside Geographical Area" isCovered={false} />
                <CoverageItem icon="leaf" text="Depreciation of Parts" isCovered={false} />
              </ExpandableSection>
              ...
              >
                <View style={styles.depreciationInfo}>
                  ...
                  <Text style={styles.depreciationInfoText}>
                    Depreciation is applied on vehicle parts during claim settlement
                  </Text>
                </View>
                ...
                <View style={styles.partsDepreciationContainer}>
                  ...
                  <View style={styles.partsDepreciationRow}>
                    <Text style={styles.partsName}>Airbags</Text>
                    <Text style={styles.partsRate}>50%</Text>
                  </View>
                  <View style={styles.partsDepreciationRow}>
              ...
              >
                <View style={styles.thirdPartyInfo}>
                  ...
                  <Text style={styles.thirdPartyInfoText}>
                    Mandatory third party insurance rates as per IRDAI (FY 2024-25)
                  </Text>
                </View>
                ...
                <View style={styles.thirdPartyNote}>
                  ...
                  <Text style={styles.thirdPartyNoteText}>
                    Personal Accident Cover (Owner-Driver): ₹15 Lakhs - Premium ₹750/year (Optional)
                  </Text>
                </View>
                ...
                <View style={[styles.thirdPartyNote, { backgroundColor: '#FEF3C7', marginTop: 10 }]}>
                  ...
                  <Text style={[styles.thirdPartyNoteText, { color: '#92400E' }]}>
                    Penalty for driving without insurance: ₹2,000 fine and/or 3 months imprisonment
                  </Text>
                </View>
              </ExpandableSection>
            </View>
